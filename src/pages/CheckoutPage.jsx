...
const CheckoutPage = ({cartItems, clearCart}) =>{
    ...
    try{
        ...
        if(!response.ok) throw new Error('Ошибка приоформлении заказа')
        ...
        console.error(error)
        allert('Ошибка при оформлении заказа')
    }}

    if (orderSubmitted){
        return(
            <div className='container mx-auto p-4'>
                <div className='mx-w-2xl mx-auto p-6 bg-white shadow rounded text-center'>
